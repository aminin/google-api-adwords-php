...
class LocationCriterionServiceErrorReason {
  ...
  public function __construct() {
    if(get_parent_class('LocationCriterionServiceErrorReason')) parent::__construct();
  }
}}
...
class LocationCriterionServiceGet {
  ...
  public function __construct($selector = NULL) {
    if(get_parent_class('LocationCriterionServiceGet')) parent::__construct();
...
class LocationCriterionServiceGetResponse {
  ...
  public function __construct($rval = NULL) {
    if(get_parent_class('LocationCriterionServiceGetResponse')) parent::__construct();
    $this->rval = $rval;
  }
}}
...
class LocationCriterionService extends AdWordsSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201206/LocationCriterionService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'LocationCriterionService', 'https://adwords.google.com/api/adwords/cm/v201206');
  }
