...
class query {
  ...
  public function __construct($query = NULL) {
    if(get_parent_class('query')) parent::__construct();
    $this->query = $query;
  }
}}
...
class queryResponse {
  ...
  public function __construct($rval = NULL) {
    if(get_parent_class('queryResponse')) parent::__construct();
    $this->rval = $rval;
  }
}}
...
class CampaignCriterionService extends AdWordsSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201206/CampaignCriterionService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'CampaignCriterionService', 'https://adwords.google.com/api/adwords/cm/v201206');
  }
