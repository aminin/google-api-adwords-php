...
class Ad {
  ...
  public function getNamespace() {
    return "https://adwords.google.com/api/adwords/cm/v201206";
  }
...
class AdGroupAd {
  ...
  public function __construct($adGroupId = NULL, $ad = NULL, $experimentData = NULL, $status = NULL, $approvalStatus = NULL, $trademarkDisapproved = NULL, $stats = NULL) {
...
class CampaignCriterion {
  ...
  public function __construct($campaignId = NULL, $isNegative = NULL, $criterion = NULL, $bidModifier = NULL, $CampaignCriterionType = NULL) {
...
class ConversionOptimizerAdGroupBids extends AdGroupBids {
  ...
  public function __construct($targetCpa = NULL, $conversionOptimizerBidType = NULL, $deduplicationMode = NULL, $interactionBids = NULL, $AdGroupBidsType = NULL) {
...
class CriterionParameter {
  ...
  public function __construct($CriterionParameterType = NULL) {
    if(get_parent_class('CriterionParameter')) parent::__construct();
...
class DomainInfoExtension extends AdExtension {
  ...
  public function __construct($domainName = NULL, $languageCode = NULL, $id = NULL, $AdExtensionType = NULL) {
    if(get_parent_class('DomainInfoExtension')) parent::__construct();
...
class InAppLinkExtension extends AdExtension {
  ...
  public function __construct($inAppLinkText = NULL, $inAppLinkUrl = NULL, $appStore = NULL, $appId = NULL, $id = NULL, $AdExtensionType = NULL) {
    if(get_parent_class('InAppLinkExtension')) parent::__construct();
...
class InteractionBid {
  ...
  public function __construct($interactionBidAmount = NULL, $minimumBid = NULL, $bidStatus = NULL, $InteractionBidType = NULL) {
    if(get_parent_class('InteractionBid')) parent::__construct();
...
class OAuthInfo {
  ...
  public function __construct($httpMethod = NULL, $httpRequestUrl = NULL, $httpAuthorizationHeader = NULL) {
    if(get_parent_class('OAuthInfo')) parent::__construct();
...
class PhoneInteractionBid extends InteractionBid {
  ...
  public function __construct($interactionBidAmount = NULL, $minimumBid = NULL, $bidStatus = NULL, $InteractionBidType = NULL) {
    if(get_parent_class('PhoneInteractionBid')) parent::__construct();
    $this->interactionBidAmount = $interactionBidAmount;
    $this->minimumBid = $minimumBid;
    $this->bidStatus = $bidStatus;
    $this->InteractionBidType = $InteractionBidType;
...
class QueryError extends ApiError {
  ...
  public function __construct($reason = NULL, $message = NULL, $fieldPath = NULL, $trigger = NULL, $errorString = NULL, $ApiErrorType = NULL) {
    if(get_parent_class('QueryError')) parent::__construct();
    $this->reason = $reason;
    $this->message = $message;
    $this->fieldPath = $fieldPath;
    $this->trigger = $trigger;
...
class String_StringMapEntry {
  ...
  public function __construct($key = NULL, $value = NULL) {
    if(get_parent_class('String_StringMapEntry')) parent::__construct();
    $this->key = $key;
    $this->value = $value;
  }
}}
...
class TargetRestrictSetting extends Setting {
  ...
  public function __construct($useAdGroup = NULL, $SettingType = NULL) {
    if(get_parent_class('TargetRestrictSetting')) parent::__construct();
...
class TargetingSettingDetail {
  ...
  public function __construct($criterionTypeGroup = NULL, $targetAll = NULL) {
    if(get_parent_class('TargetingSettingDetail')) parent::__construct();
...
class TargetingSetting extends Setting {
  ...
  public function __construct($details = NULL, $SettingType = NULL) {
    if(get_parent_class('TargetingSetting')) parent::__construct();
...
class UnknownBiddingStrategy extends BiddingStrategy {
  ...
  public function __construct($forwardCompatibilityMap = NULL, $BiddingStrategyType = NULL) {
    if(get_parent_class('UnknownBiddingStrategy')) parent::__construct();
    $this->forwardCompatibilityMap = $forwardCompatibilityMap;
    $this->BiddingStrategyType = $BiddingStrategyType;
  }
}}
...
class Webpage extends Criterion {
  ...
  public function __construct($parameter = NULL, $criteriaCoverage = NULL, $criteriaSamples = NULL, $id = NULL, $type = NULL, $CriterionType = NULL) {
    if(get_parent_class('Webpage')) parent::__construct();
...
class WebpageCondition {
  ...
  public function __construct($operand = NULL, $argument = NULL) {
    if(get_parent_class('WebpageCondition')) parent::__construct();
    $this->operand = $operand;
    $this->argument = $argument;
  }
}}
...
class WebpageParameter extends CriterionParameter {
  ...
  public function __construct($criterionName = NULL, $conditions = NULL, $CriterionParameterType = NULL) {
    if(get_parent_class('WebpageParameter')) parent::__construct();
...
/**
 * Represents a dynamic search ad. This ad will have its headline and url autogenerated
 * at serving time according to domain name specific information provided by DomainInfoExtension
 * linked at the campaign level.
 * 
 * Autogenerated fields: headline and url (url may be optionally specified for tracking purposes)
...
class DynamicSearchAd extends Ad {
  ...
  public function __construct($description1 = NULL, $description2 = NULL, $id = NULL, $url = NULL, $displayUrl = NULL, $disapprovalReasons = NULL, $AdType = NULL) {
    if(get_parent_class('DynamicSearchAd')) parent::__construct();
    $this->description1 = $description1;
    $this->description2 = $description2;
    $this->id = $id;
    $this->url = $url;
...
class AdGroupAdApprovalStatus {
  ...
  public function __construct() {
    if(get_parent_class('AdGroupAdApprovalStatus')) parent::__construct();
  }
}}
...
class AdxErrorReason {
  ...
  public function __construct() {
    if(get_parent_class('AdxErrorReason')) parent::__construct();
  }
}}
...
class CriterionTypeGroup {
  ...
  public function __construct() {
    if(get_parent_class('CriterionTypeGroup')) parent::__construct();
  }
}}
...
class InAppLinkExtensionAppStore {
  ...
  public function __construct() {
    if(get_parent_class('InAppLinkExtensionAppStore')) parent::__construct();
  }
}}
...
class InteractionBidBidStatus {
  ...
  public function __construct() {
    if(get_parent_class('InteractionBidBidStatus')) parent::__construct();
  }
}}
...
class LocationTargetingStatus {
  ...
  public function __construct() {
    if(get_parent_class('LocationTargetingStatus')) parent::__construct();
  }
}}
...
class MobileDeviceDeviceType {
  ...
  public function __construct() {
    if(get_parent_class('MobileDeviceDeviceType')) parent::__construct();
  }
}}
...
class OperatingSystemVersionOperatorType {
  ...
  public function __construct() {
    if(get_parent_class('OperatingSystemVersionOperatorType')) parent::__construct();
  }
}}
...
class QueryErrorReason {
  ...
  public function __construct() {
    if(get_parent_class('QueryErrorReason')) parent::__construct();
  }
}}
...
class RichMediaAdRichMediaAdType {
  ...
  public function __construct() {
    if(get_parent_class('RichMediaAdRichMediaAdType')) parent::__construct();
  }
}}
...
class ThirdPartyRedirectAdExpandingDirection {
  ...
  public function __construct() {
    if(get_parent_class('ThirdPartyRedirectAdExpandingDirection')) parent::__construct();
  }
}}
...
class WebpageConditionOperand {
  ...
  public function __construct() {
    if(get_parent_class('WebpageConditionOperand')) parent::__construct();
  }
}}
...
class AdSchedule extends Criterion {
  ...
  public function __construct($dayOfWeek = NULL, $startHour = NULL, $startMinute = NULL, $endHour = NULL, $endMinute = NULL, $id = NULL, $type = NULL, $CriterionType = NULL) {
    if(get_parent_class('AdSchedule')) parent::__construct();
...
class AdxError extends ApiError {
  ...
  public function __construct($reason = NULL, $fieldPath = NULL, $trigger = NULL, $errorString = NULL, $ApiErrorType = NULL) {
    if(get_parent_class('AdxError')) parent::__construct();
    $this->reason = $reason;
    $this->fieldPath = $fieldPath;
    $this->trigger = $trigger;
    $this->errorString = $errorString;
...
class KeywordMatchSetting extends Setting {
  ...
  public function __construct($optIn = NULL, $SettingType = NULL) {
    if(get_parent_class('KeywordMatchSetting')) parent::__construct();
    $this->optIn = $optIn;
    $this->SettingType = $SettingType;
  }
}}
...
class BulkMutateJobService extends AdWordsSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://adwords.google.com/api/adwords/job/v201206/BulkMutateJobService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'BulkMutateJobService', 'https://adwords.google.com/api/adwords/cm/v201206');
  }
