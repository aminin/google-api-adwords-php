...
class getAgeRangeCriterion {
  ...
  public function __construct() {
    if(get_parent_class('getAgeRangeCriterion')) parent::__construct();
  }
}}
...
class getAgeRangeCriterionResponse {
  ...
  public function __construct($rval = NULL) {
    if(get_parent_class('getAgeRangeCriterionResponse')) parent::__construct();
    $this->rval = $rval;
  }
}}
...
class getCarrierCriterion {
  ...
  public function __construct() {
    if(get_parent_class('getCarrierCriterion')) parent::__construct();
  }
}}
...
class getCarrierCriterionResponse {
  ...
  public function __construct($rval = NULL) {
    if(get_parent_class('getCarrierCriterionResponse')) parent::__construct();
    $this->rval = $rval;
  }
}}
...
class getGenderCriterion {
  ...
  public function __construct() {
    if(get_parent_class('getGenderCriterion')) parent::__construct();
  }
}}
...
class getGenderCriterionResponse {
  ...
  public function __construct($rval = NULL) {
    if(get_parent_class('getGenderCriterionResponse')) parent::__construct();
    $this->rval = $rval;
  }
}}
...
class getLanguageCriterion {
  ...
  public function __construct() {
    if(get_parent_class('getLanguageCriterion')) parent::__construct();
  }
}}
...
class getLanguageCriterionResponse {
  ...
  public function __construct($rval = NULL) {
    if(get_parent_class('getLanguageCriterionResponse')) parent::__construct();
    $this->rval = $rval;
  }
}}
...
class getMobileDeviceCriterion {
  ...
  public function __construct() {
    if(get_parent_class('getMobileDeviceCriterion')) parent::__construct();
  }
}}
...
class getMobileDeviceCriterionResponse {
  ...
  public function __construct($rval = NULL) {
    if(get_parent_class('getMobileDeviceCriterionResponse')) parent::__construct();
    $this->rval = $rval;
  }
}}
...
class getOperatingSystemVersionCriterion {
  ...
  public function __construct() {
    if(get_parent_class('getOperatingSystemVersionCriterion')) parent::__construct();
  }
}}
...
class getOperatingSystemVersionCriterionResponse {
  ...
  public function __construct($rval = NULL) {
    if(get_parent_class('getOperatingSystemVersionCriterionResponse')) parent::__construct();
    $this->rval = $rval;
  }
}}
...
class getUserInterestCriterion {
  ...
  public function __construct() {
    if(get_parent_class('getUserInterestCriterion')) parent::__construct();
  }
}}
...
class getUserInterestCriterionResponse {
  ...
  public function __construct($rval = NULL) {
    if(get_parent_class('getUserInterestCriterionResponse')) parent::__construct();
    $this->rval = $rval;
  }
}}
...
class getVerticalCriterion {
  ...
  public function __construct() {
    if(get_parent_class('getVerticalCriterion')) parent::__construct();
  }
}}
...
class getVerticalCriterionResponse {
  ...
  public function __construct($rval = NULL) {
    if(get_parent_class('getVerticalCriterionResponse')) parent::__construct();
    $this->rval = $rval;
  }
}}
...
class ConstantDataService extends AdWordsSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201206/ConstantDataService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'ConstantDataService', 'https://adwords.google.com/api/adwords/cm/v201206');
  }
