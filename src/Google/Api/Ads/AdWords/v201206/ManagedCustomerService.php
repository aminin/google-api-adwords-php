...
class ManagedCustomerServiceError extends ApiError {
   ...
   */
  public function getNamespace() {
    return "https://adwords.google.com/api/adwords/mcm/v201206";
  }
  ...
  public function __construct($reason = NULL, $customerIds = NULL, $fieldPath = NULL, $trigger = NULL, $errorString = NULL, $ApiErrorType = NULL) {
    if(get_parent_class('ManagedCustomerServiceError')) parent::__construct();
    $this->reason = $reason;
...
class ManagedCustomerLink {
  ...
  public function __construct($managerCustomerId = NULL, $clientCustomerId = NULL) {
    if(get_parent_class('ManagedCustomerLink')) parent::__construct();
...
class ManagedCustomer {
  ...
  public function __construct($name = NULL, $login = NULL, $companyName = NULL, $customerId = NULL, $canManageClients = NULL, $currencyCode = NULL, $dateTimeZone = NULL) {
    if(get_parent_class('ManagedCustomer')) parent::__construct();
    $this->name = $name;
    $this->login = $login;
...
class ManagedCustomerOperation extends Operation {
  ...
  public function __construct($operand = NULL, $operator = NULL, $OperationType = NULL) {
    if(get_parent_class('ManagedCustomerOperation')) parent::__construct();
...
class ManagedCustomerPage extends Page {
  ...
  public function __construct($entries = NULL, $links = NULL, $totalNumEntries = NULL, $PageType = NULL) {
    if(get_parent_class('ManagedCustomerPage')) parent::__construct();
...
class ManagedCustomerReturnValue {
  ...
  public function __construct($value = NULL) {
    if(get_parent_class('ManagedCustomerReturnValue')) parent::__construct();
    $this->value = $value;
  }
}}
...
class ManagedCustomerServiceErrorReason {
  ...
  public function __construct() {
    if(get_parent_class('ManagedCustomerServiceErrorReason')) parent::__construct();
  }
}}
...
class ManagedCustomerServiceGet {
  ...
  public function __construct($serviceSelector = NULL) {
    if(get_parent_class('ManagedCustomerServiceGet')) parent::__construct();
...
class ManagedCustomerServiceGetResponse {
  ...
  public function __construct($rval = NULL) {
    if(get_parent_class('ManagedCustomerServiceGetResponse')) parent::__construct();
    $this->rval = $rval;
  }
}}
...
class ManagedCustomerServiceMutate {
  ...
  public function __construct($operations = NULL) {
    if(get_parent_class('ManagedCustomerServiceMutate')) parent::__construct();
    $this->operations = $operations;
  }
}}
...
class ManagedCustomerServiceMutateResponse {
  ...
  public function __construct($rval = NULL) {
    if(get_parent_class('ManagedCustomerServiceMutateResponse')) parent::__construct();
    $this->rval = $rval;
  }
}}
...
class ManagedCustomerService extends AdWordsSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://adwords.google.com/api/adwords/mcm/v201206/ManagedCustomerService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'ManagedCustomerService', 'https://adwords.google.com/api/adwords/mcm/v201206');
  }
