...
class Customer {
  ...
  public function __construct($customerId = NULL, $currencyCode = NULL, $dateTimeZone = NULL, $descriptiveName = NULL, $canManageClients = NULL) {
    if(get_parent_class('Customer')) parent::__construct();
...
class CustomerServiceGet {
  ...
  public function __construct() {
    if(get_parent_class('CustomerServiceGet')) parent::__construct();
  }
}}
...
class CustomerServiceGetResponse {
  ...
  public function __construct($rval = NULL) {
    if(get_parent_class('CustomerServiceGetResponse')) parent::__construct();
    $this->rval = $rval;
  }
}}
...
class CustomerService extends AdWordsSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://adwords.google.com/api/adwords/mcm/v201206/CustomerService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'CustomerService', 'https://adwords.google.com/api/adwords/mcm/v201206');
  }
