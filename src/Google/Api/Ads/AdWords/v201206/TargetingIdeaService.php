...
class AdFormatSpec {
   ...
   */
  public function getNamespace() {
    return "https://adwords.google.com/api/adwords/o/v201206";
  }
...
class AdSpec {
  ...
  public function __construct($DisplayAdSpec = NULL, $InStreamAdSpec = NULL, $TextAdSpec = NULL) {
    if(get_parent_class('AdSpec')) parent::__construct();
...
class DisplayAdSpec {
  ...
  public function __construct($displayTypes = NULL, $activationOptions = NULL, $adSizeSpecs = NULL) {
    if(get_parent_class('DisplayAdSpec')) parent::__construct();
...
class DisplayAdSpecAdSizeSpec {
  ...
  public function __construct($width = NULL, $height = NULL, $activationOptionFilter = NULL) {
    if(get_parent_class('DisplayAdSpecAdSizeSpec')) parent::__construct();
    $this->width = $width;
    $this->height = $height;
...
class DisplayType {
  ...
  public function __construct($FlashDisplayType = NULL, $HtmlDisplayType = NULL, $ImageDisplayType = NULL) {
    if(get_parent_class('DisplayType')) parent::__construct();
...
class FlashDisplayType {
  ...
  public function __construct() {
    if(get_parent_class('FlashDisplayType')) parent::__construct();
  }
}}
...
class HtmlDisplayType {
  ...
  public function __construct($htmlOption = NULL) {
    if(get_parent_class('HtmlDisplayType')) parent::__construct();
...
class ImageDisplayType {
  ...
  public function __construct() {
    if(get_parent_class('ImageDisplayType')) parent::__construct();
  }
}}
...
class InStreamAdSpec {
  ...
  public function __construct($inStreamTypes = NULL, $durations = NULL) {
    if(get_parent_class('InStreamAdSpec')) parent::__construct();
...
class SearchVolumeSearchParameter extends SearchParameter {
  ...
  public function __construct($operation = NULL, $SearchParameterType = NULL) {
    if(get_parent_class('SearchVolumeSearchParameter')) parent::__construct();
    $this->operation = $operation;
    $this->SearchParameterType = $SearchParameterType;
  }
}}
...
class TextAdSpec {
  ...
  public function __construct() {
    if(get_parent_class('TextAdSpec')) parent::__construct();
  }
}}
...
class DisplayAdSpecActivationOption {
  ...
  public function __construct() {
    if(get_parent_class('DisplayAdSpecActivationOption')) parent::__construct();
  }
}}
...
class HtmlDisplayTypeHtmlOption {
  ...
  public function __construct() {
    if(get_parent_class('HtmlDisplayTypeHtmlOption')) parent::__construct();
  }
}}
...
class InStreamAdSpecInStreamType {
  ...
  public function __construct() {
    if(get_parent_class('InStreamAdSpecInStreamType')) parent::__construct();
  }
}}
...
class AdSpecListAttribute extends Attribute {
  ...
  public function __construct($value = NULL, $AttributeType = NULL) {
    if(get_parent_class('AdSpecListAttribute')) parent::__construct();
    $this->value = $value;
    $this->AttributeType = $AttributeType;
  }
}}
...
class AdSpecListSearchParameter extends SearchParameter {
  ...
  public function __construct($adSpecs = NULL, $SearchParameterType = NULL) {
    if(get_parent_class('AdSpecListSearchParameter')) parent::__construct();
...
class RelatedToQuerySearchParameter extends SearchParameter {
  ...
  public function __construct($queries = NULL, $SearchParameterType = NULL) {
    if(get_parent_class('RelatedToQuerySearchParameter')) parent::__construct();
...
class TargetingIdeaService extends AdWordsSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://adwords.google.com/api/adwords/o/v201206/TargetingIdeaService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'TargetingIdeaService', 'https://adwords.google.com/api/adwords/o/v201206');
  }
