...
/**
 * <span class="constraint Selectable">This field can be selected using the value "PlatformName".</span>
...
/**
 * <span class="constraint Selectable">This field can be selected using the value "Vertices".</span>
 * <span class="constraint ReadOnly">This field is read only and should not be set.  If this field is sent to the API, it will be ignored.</span>
 * 
 * 
 * 
...
class BulkOpportunityService extends AdWordsSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://adwords.google.com/api/adwords/o/v201109/BulkOpportunityService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'BulkOpportunityService', 'https://adwords.google.com/api/adwords/o/v201109');
  }
