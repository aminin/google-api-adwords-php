...
class Account {
  ...
  public function __construct($customerId = NULL, $login = NULL, $companyName = NULL, $canManageClients = NULL) {
...
class Link {
  ...
  public function __construct($managerId = NULL, $clientId = NULL, $serviceType = NULL, $typeOfLink = NULL, $descriptiveName = NULL, $LinkType = NULL) {
...
class ServicedAccountSelector {
  ...
  public function __construct($customerIds = NULL, $enablePaging = NULL, $serviceTypes = NULL, $submanagersOnly = NULL) {
...
class ServiceType {
  ...
  public function __construct() {
    if(get_parent_class('ServiceType')) parent::__construct();
  }
}}
...
class ServicedAccountService extends AdWordsSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://adwords.google.com/api/adwords/mcm/v201008/ServicedAccountService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'ServicedAccountService', 'https://adwords.google.com/api/adwords/mcm/v201008');
  }
