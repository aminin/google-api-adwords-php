...
class AlertError extends ApiError {
   ...
   */
  public function getNamespace() {
    return "https://adwords.google.com/api/adwords/mcm/v201101";
  }
...
class AlertService extends AdWordsSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://adwords.google.com/api/adwords/mcm/v201101/AlertService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'AlertService', 'https://adwords.google.com/api/adwords/mcm/v201101');
  }
