...
class ReportDefinitionField {
  ...
  public function __construct($fieldName = NULL, $displayFieldName = NULL, $xmlAttributeName = NULL, $fieldType = NULL, $enumValues = NULL, $canSelect = NULL, $canFilter = NULL, $enumValuePairs = NULL) {
...
class ClientSelector {
  ...
  public function __construct($login = NULL, $predicates = NULL) {
    if(get_parent_class('ClientSelector')) parent::__construct();
    $this->login = $login;
...
class ReportDefinition {
  ...
  public function __construct($id = NULL, $selector = NULL, $reportName = NULL, $reportType = NULL, $hasAttachment = NULL, $dateRangeType = NULL, $downloadFormat = NULL, $creationTime = NULL, $crossClient = NULL, $clientSelectors = NULL) {
...
if (!class_exists("ReportDefinitionServiceMutate", FALSE)) {
/**
...
class ReportDefinitionService extends AdWordsSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201101/ReportDefinitionService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'ReportDefinitionService', 'https://adwords.google.com/api/adwords/cm/v201101');
  }
