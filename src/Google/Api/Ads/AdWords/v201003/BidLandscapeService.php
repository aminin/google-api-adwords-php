...
class BidLandscapeService extends AdWordsSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201003/BidLandscapeService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'BidLandscapeService', 'https://adwords.google.com/api/adwords/cm/v201003');
  }
