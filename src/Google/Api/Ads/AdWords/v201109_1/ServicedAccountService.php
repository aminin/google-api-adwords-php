...
class ServicedAccountService extends AdWordsSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://adwords.google.com/api/adwords/mcm/v201109_1/ServicedAccountService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'ServicedAccountService', 'https://adwords.google.com/api/adwords/mcm/v201109_1');
  }
