...
class BudgetOptimizerAdGroupBids extends AdGroupBids {
  ...
  public function __construct($proxyKeywordMaxCpc = NULL, $proxySiteMaxCpc = NULL, $enhancedCpcEnabled = NULL, $interactionBids = NULL, $AdGroupBidsType = NULL) {
...
class CampaignCriterion {
  ...
  public function __construct($campaignId = NULL, $isNegative = NULL, $criterion = NULL, $CampaignCriterionType = NULL) {
...
class ManualCPCAdGroupBids extends AdGroupBids {
  ...
  public function __construct($keywordMaxCpc = NULL, $keywordContentMaxCpc = NULL, $siteMaxCpc = NULL, $enhancedCpcEnabled = NULL, $interactionBids = NULL, $AdGroupBidsType = NULL) {
...
class BulkMutateJobService extends AdWordsSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://adwords.google.com/api/adwords/job/v201109_1/BulkMutateJobService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'BulkMutateJobService', 'https://adwords.google.com/api/adwords/cm/v201109_1');
  }
