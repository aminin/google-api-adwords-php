...
class AdGroupChangeData {
   ...
   */
  public function getNamespace() {
    return "https://adwords.google.com/api/adwords/ch/v201109_1";
  }
...
class CustomerSyncService extends AdWordsSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://adwords.google.com/api/adwords/ch/v201109_1/CustomerSyncService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'CustomerSyncService', 'https://adwords.google.com/api/adwords/ch/v201109_1');
  }
