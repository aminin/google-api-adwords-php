...
class ApiUsageError extends ApiError {
   ...
   */
  public function getNamespace() {
    return "https://adwords.google.com/api/adwords/info/v201109_1";
  }
...
class InfoService extends AdWordsSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://adwords.google.com/api/adwords/info/v201109_1/InfoService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'InfoService', 'https://adwords.google.com/api/adwords/info/v201109_1');
  }
