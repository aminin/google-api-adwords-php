<?php
/**
 * This example gets related keywords using the TargetingIdeaService.
 *
 * PHP version 5
 *
 ...
 * This example gets related keywords using the TargetingIdeaService.
 */
class GetRelatedKeywordsExample {
  static function main() {
    try {
      ...
      $keyword = new Keyword('cheap airline tickets', 'BROAD');
      ...
      $selector->searchParameters = array(
          ...
          new ExcludedKeywordSearchParameter(array($keyword)),
          new KeywordMatchTypeSearchParameter($keyword->matchType),
          new CompetitionSearchParameter('LOW'),
      ...
      if (isset($page->entries)) {
        foreach ($page->entries as $targetingIdea) {
          GetRelatedKeywordsExample::DisplayTargetingIdea($targetingIdea);
          print "\n";
        }
      } else {
...
GetRelatedKeywordsExample::main();
