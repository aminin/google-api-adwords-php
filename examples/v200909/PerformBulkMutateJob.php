 ...
 * @param $adGroupId1 the ad group to which a text ad will be added
 * @param $adGroupId2 the ad group to which an image ad will be added
...
function CreateAdGroupAdOperations($adGroupId1, $adGroupId2) {
  ...
  $textAdGroupAd->adGroupId = $adGroupId1;
  ...
  $imageAdGroupAd->adGroupId = $adGroupId1;
  ...
  return array($textAdGroupAdOperation, $imageAdGroupAdOperation);
}

/**
 * Creates an array of ad group criterion operations to be performed by the
 * BulkMutateJobService.
 * @param $adGroupId1 the ad group to which a keyword will be added
 * @param $adGroupId2 the ad group to which a placement will be added
...
function CreateAdGroupCriterionOperations($adGroupId1, $adGroupId2) {
  ...
  $keywordAdGroupCriterion->adGroupId = $adGroupId1;
  ...
  $placementAdGroupCriterion->adGroupId = $adGroupId2;
  ...
  return array($keywordAdGroupCriterionOperation,
...
try {
  ...
  $bulkMutateJobService = $user->GetService('BulkMutateJobService', 'v200909');
