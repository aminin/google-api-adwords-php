 ...
 * groups, run GetAllAdGroups.php. To get criteria, run
 * GetAllAdGroupCriteria.php.
 *
 ...
 * @link       http://code.google.com/apis/adwords/v2009/docs/reference/ReportDefinitionService.html
 */
...
try {
  ...
  $bidLandscapeService = $user->GetBidLandscapeService('v201003');
