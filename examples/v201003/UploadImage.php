<?php
/**
 * This example uploads an image. To get images, run GetAllImages.php.
 *
 ...
 * @link       http://code.google.com/apis/adwords/v2009/docs/reference/MediaService.html
 */
...
try {
  ...
  $mediaService = $user->GetMediaService('v201003');
