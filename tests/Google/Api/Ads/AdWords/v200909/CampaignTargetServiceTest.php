...
require_once dirname(__FILE__) . '/../../../../../../src/Google/Api/Ads/AdWords/v200909/cm/CampaignTargetService.php';
...
class CampaignTargetServiceTest extends AdsTestCase {
  ...
  protected function setUp() {
    ...
    $this->service = $user->GetCampaignTargetService();
  ...
  public function testGetAllForCampaign() {
    ...
    $this->assertEquals(6, sizeof($page->entries));
  }
  ...
  public function testGetAll() {
    ...
    $this->assertNotNull($page);
    $this->assertGreaterThanOrEqual(6, sizeof($page->entries));
  }
