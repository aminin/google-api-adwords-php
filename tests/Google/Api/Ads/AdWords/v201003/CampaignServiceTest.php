...
class CampaignServiceTest extends PHPUnit_Framework_TestCase {
  ...
  /**
   * Test whether we can create a campaign using v201003.
   */
  ...
  /**
   * Test whether we can fetch an existing campaign using v201003.
   */
  ...
  /**
   * Test whether we can update a campaign using v201003.
   */
  ...
  /**
   * Test whether we can update campaigns using v201003.
   */
