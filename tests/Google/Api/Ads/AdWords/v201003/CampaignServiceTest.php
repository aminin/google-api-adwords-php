...
require_once dirname(__FILE__) . '/../../../../../../src/Google/Api/Ads/AdWords/v201003/CampaignService.php';
...
class CampaignServiceTest extends AdsTestCase {
  ...
  public function testAdd() {
    ...
    $campaign->biddingStrategy = new ManualCPC('ON');
    ...
    $excludeFields = array('id', 'budget->amount->ComparableValueType',
        'biddingStrategy->BiddingStrategyType', 'servingStatus');
