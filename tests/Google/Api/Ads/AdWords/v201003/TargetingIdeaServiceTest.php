...
class TargetingIdeaServiceTest extends PHPUnit_Framework_TestCase {
  ...
  /**
   * Test whether we can request competition search parameter using v201003.
   */
  ...
  /**
   * Test whether we can request country target search parameter using v201003.
   */
  ...
  /**
   * Test whether we can request global monthly search parameter using v201003.
   */
  ...
  /**
   * Test whether we can request mobile search parameter using v201003.
   */
  ...
  /**
   * Test whether we can request idea text matches search parameter using
   * v201003.
   */
  public function testGetIdeaTextMatchesSearchParameter() {
    $selector = new TargetingIdeaSelector();
    $selector->searchParameters = array(
        new IdeaTextMatchesSearchParameter(array('presidential vote')),
        new RelatedToKeywordSearchParameter(array(
            new Keyword('presidential vote', 'EXACT'))));
    $selector->ideaType = 'KEYWORD';
    $selector->requestType = 'IDEAS';
  ...
  /**
   * Test whether we can request placement type search parameter using v201003.
   */
   ...
   * retrieve complete set of resulting pages using v201003.
   */
  ...
  /**
   * Test whether we can request bulk keyword ideas using v201003.
   */
