...
class InfoServiceTest extends PHPUnit_Framework_TestCase {
  ...
  /**
   * Test whether we can get free usage units per month using v201003.
   */
  ...
  /**
   * Test whether we can get total usage units per month using v201003.
   */
  ...
  /**
   * Test whether we can get operation count using v201003.
   */
  ...
  /**
   * Test whether we can get unit count using v201003.
   */
  ...
  /**
   * Test whether we can get unit count for clients using v201003.
   */
  ...
  /**
   * Test whether we can get method cost using v201003.
   */
