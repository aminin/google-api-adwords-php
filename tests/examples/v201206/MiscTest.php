<?php
/**
 * Integration tests for misc examples.
 *
 * PHP version 5
 *
...
foreach (glob($examplesPath . 'v201206/Misc/*.php') as $filename) {
 ...
 * Integration tests for misc examples.
 */
class MiscTest extends AdsTestCase {
  private $user;
  private $testUtils;

  public static function suite() {
    $suite = new AdWordsTestSuite(__CLASS__);
    $suite->SetVersion('v201206');
    return $suite;
  }
  ...
  // UseOAuthExample can't be tested because it requires human input.
}
