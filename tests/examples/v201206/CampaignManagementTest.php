...
foreach (glob($examplesPath . 'v201206/CampaignManagement/*.php')
    as $filename) {
...
class CampaignManagementTest extends AdsTestCase {
  ...
  public function testGetAllDisapprovedAdsWithAwqlExample() {
    GetAllDisapprovedAdsWithAwqlExample($this->user, $this->adGroupId);
  }
