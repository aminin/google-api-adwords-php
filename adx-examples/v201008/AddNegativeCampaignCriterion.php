<?php
/**
 * This example adds a negative placement to a campaign. To get campaigns, run
 * GetAllCampaigns.php.
 *
...
try {
  ...
  $campaignCriterionService = $user->GetCampaignCriterionService('v201008');

  $campaignId = (float) 'INSERT_CAMPAIGN_ID_HERE';

  // Create placement.
  $placement = new Placement();
  $placement->url = 'http://juptier.google.com';
  ...
  $negativeCampaignCriterion->criterion = $placement;
