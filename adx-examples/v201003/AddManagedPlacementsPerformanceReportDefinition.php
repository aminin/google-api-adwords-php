<?php
/**
 * This example adds a managed placements performance report. To get ad groups,
 * run GetAllAdGroups.php. To get report fields, run GetReportFields.php.
 *
...
try {
  ...
  $selector->fields = array('AdGroupId', 'Id', 'PlacementUrl',
  ...
  $reportDefinition->reportName =
      'Managed placements performance report #' . time();
  $reportDefinition->dateRangeType = 'CUSTOM_DATE';
  $reportDefinition->reportType = 'MANAGED_PLACEMENTS_PERFORMANCE_REPORT';
