...
try {
  ...
  $adGroupCriterionService =
      $user->GetService('AdGroupCriterionService', 'v201003');
  ...
  // Create bids.
  $bids = new ManualCPMAdGroupCriterionBids();
  $bids->maxCpm = new Bid(new Money((float) 1000000));
  ...
  if (isset($result->value)) {
    foreach ($result->value as $adGroupCriterion) {
      print 'Ad group criterion with ad group id "'
          ...
          . $adGroupCriterion->bids->maxCpm->amount->microAmount
          . "\" was updated.\n";
    }
  } else {
