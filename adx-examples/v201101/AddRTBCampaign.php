...
try {
  ...
  // Set the campaign network options to the Content Network (Display Network).
  ...
  $rtbSetting = new RealTimeBiddingSetting();
  $rtbSetting->optIn = TRUE;
  $campaign->settings = array($rtbSetting);
  ...
  if (isset($result->value)) {
    foreach ($result->value as $campaign) {
      print 'Campaign with name "' . $campaign->name . '" and id "'
          . $campaign->id . "\" was added with real-time bidding enabled.\n";
    }
  } else {
